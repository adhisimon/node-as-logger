...
module.exports = (options) => {
  ...
  const stderrLevels = (options && Array.isArray(options.stderrLevels) && options.stderrLevels) || [];
  ...
  logger.debug(`${MODULE_NAME} 076307BF: Console transport initialized`, {
    logLevel,
    stderrLevels
  });
  ...
  if (!disableFileTransport) {
    ...
    logger.debug(`${MODULE_NAME} F9CB9E88: File transport added`, {
      logFileLevel,
      logDir,
      logBaseFilename,
      logKeepFiles
